...
class Plugin {
	...
	public function __construct() {
		register_activation_hook( DCMS_REPORTS_BASE_NAME, [ $this, 'dcms_activation_plugin' ] );
		register_deactivation_hook( DCMS_REPORTS_BASE_NAME, [ $this, 'dcms_deactivation_plugin' ] );
	}
